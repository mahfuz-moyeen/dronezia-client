                ...
                <div className='max-w-screen-xl mx-auto'>
                    <div className="footer md:flex md:justify-around  p-10 bg-neutral text-neutral-content items-center ">
                        <div>
                            ...
                            <p>Dronezia warhouse<br />Providing reliable tech since 2010
                            <br />123-A, Road-B, Block-1<br />Mirpur, Dhaka</p>
                        ...
                        <div>
                            ...
                            <div className="grid grid-flow-col gap-4">
                                ...
                                <a href='https://www.youtube.com/channel/UCNZL1dPRRKSeTfV-jKeZtNg' target='blank'>
                    ...
                    <div className="footer-center p-5 text-neutral-content">
                        <p className=' text-gray-400'>Copyright &copy; {year} - All right reserved by Dronezia warhouse</p>
                    </div>
                </div>
            </footer>
        </div>
